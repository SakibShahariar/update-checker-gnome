...
.update-checker-container { background-color: ${hexToRgba(c.surface_container, 0.85)}; border-color: ${hexToRgba(c.outline_variant, 0.45)}; border-width: 1px; }
...
.update-checker-menu .popup-menu-item { border-radius: 12px; margin: 1px 4px; padding-left: 8px; padding-right: 8px; border-color: transparent; border-width: 0; }
